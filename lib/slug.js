...
function Slug() {
    ...
    utils.defineProperty(this, 'addData', function(filename, data) {
        ...
        gitHashes[contentHash] = utils.getGitHash(data);
    ...
    utils.defineProperty(this, 'getGitHash', function(filename) {
        var contentHash = filenames[filename];
        if (!contentHash) { return null; }
    ...
    Object.defineProperty(this, 'json', {
        enumerable: true,
        get: function() {
            var result = {contents: {}, filenames: {}, gitHashes: {}, version: 2};
    ...
    utils.defineProperty(this, 'unsigned', function() {
        var signedPayload = {
            address: '',
...
function load(json) {
    ...
    try {
        result = verify(json);
        utils.defineProperty(result, 'signed', data.address)
    } catch (error) {
        result = parsePayload(data.payload);
        utils.defineProperty(result, 'signed', '')
    }
