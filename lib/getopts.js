...
function getopts(options, argv) {
    ...
    return seq.then(function() {
        ...
        if (options._provider) {
            if (opts.options.rpc) {
                opts.provider = new ethers.providers.JsonRpcProvider(opts.options.rpc, opts.options.testnet);
            } else {
...
Account.prototype.parseValue = function(value) {
    return new Promise(function(resolve, reject) {
        ...
        fauxAccount.sendTransaction = function(tx) {
            /*
            // Do these still make sense? We need to add more granularity to the
            // _accounts
