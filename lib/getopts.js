...
function getopts(options, argv) {
    ...
    if (options._defaultAccount && opts.options.account == null) {
        try {
...
Account.prototype.parseValue = function(value, opts) {
    ...
    function showTransaction(tx) {
        ...
        seq = seq.then(function() {
            ...
            if (tx.nonce != null) {
                noncePromise = Promsie.resolve(tx.nonce);
    ...
    return ethers.Wallet.fromEncryptedWallet(json, password).then(function(wallet) {
        wallet.provider = opts.provider;
        return {
            address: wallet.address,
            getAddress: function() { return wallet.address; },
            ...
            signMessage: function(message) {
                ...
                //var promise = getConfirm('Sign Message [Y/n]? ').then(function(confirm) {
                    if (!confirm) {
